@echo off
echo ===============================================
echo Boozer Files Import to WHISKEY Database
echo ===============================================
...
echo.
echo Importing Boozer files into WHISKEY database...
powershell -ExecutionPolicy Bypass -File "import-boozer-files.ps1"
